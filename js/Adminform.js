import {saveAdmin} from './firebase.js'
...
adminForm.addEventListener('submit', (e) => {
    ...
    if(document.getElementById('name').value == "" || document.getElementById('phone').value == "" || document.getElementById('email').value == "" || document.getElementById('school').value == "" || document.getElementById('experience').value == "" || document.getElementById('location').value == ""){
        ...
        const phone = adminForm['phone']
        const email = adminForm['email']
        const school = adminForm['school']
        const experience = adminForm['experience']
        const location = adminForm['location']
        const able = adminForm['able']

        saveAdmin(name.value, phone.value, email.value, school.value, experience.value, location.value, able.value)
