import {saveAuxCost} from './firebase.js'

window.addEventListener('DOMContentLoaded', () => {
    console.log('funciona');
})

const CostosForm = document.getElementById('costos-form')
...
CostosForm.addEventListener('submit', (e) => {
    ...
    if(document.getElementById('name').value == "" || document.getElementById('phone').value == "" || document.getElementById('email').value == "" || document.getElementById('school').value == "" || document.getElementById('experience').value == "" || document.getElementById('location').value == ""){
        ...
        const name = CostosForm['name']
        const phone = CostosForm['phone']
        const email = CostosForm['email']
        const school = CostosForm['school']
        const experience = CostosForm['experience']
        const location = CostosForm['location']
        const able = CostosForm['able']

        saveAuxCost(name.value, phone.value, email.value, school.value, experience.value, location.value, able.value)
